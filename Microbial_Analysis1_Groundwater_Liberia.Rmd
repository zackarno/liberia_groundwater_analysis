...
### Basic Visualization
This is the basic visualization the ordisurf function calls. It's intersting, but if we can manipulate the data with ggplot we can make it more beautifuland compelling.
